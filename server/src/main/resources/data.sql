insert into arts(vendor_art_id, title, start_date, end_date, actors, rate, location, poster_url, info_urls)
values (98765001, '상실의 징후들', '2023-06-10', '2024-08-31', '', 0, '뮤지엄 원',
       ...
       (98765002, '뮤지컬 〈헤드윅〉', '2024-03-22', '2024-06-23', '조정석, 유연석, 전동석, 장은아, 이예은, 여은', 17, '샤롯데씨어터',
       ...
       (98765003, '［서울 대학로］연극 라면', '2023-03-20', '2024-02-25', '', 12, '해피씨어터',
